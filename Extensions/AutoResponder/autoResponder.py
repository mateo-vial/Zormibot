...
class MyCog(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        # T'écris bcp
        if len(message.content) > 200 and random.randrange(10) == 0:
        ...
        # Feur
        if random.randrange(20) == 0 and ''.join(c for c in message.content if c.isalpha()).lower().endswith('quoi'):
